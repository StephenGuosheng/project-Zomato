...
url = 'https://www.zomato.com/istanbul/collections'
...
driver.get (url)
# containers
containers = driver.find_elements(By.XPATH, ' .//div[@id="root"]/div/div[3]/div/section/section/div/div')
...
print (df)
df.to_csv('Istanbul collection.csv')